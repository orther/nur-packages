#+TITLE: nur.orther.dev
#+SUBTITLE: NixOS, nix-darwin User Repository
#+AUTHOR: Brandon Orther @orther 
#+DESCRIPTION: @orther's Nix User Repository for NixOS and nix-darwin
#+LICENSE: Creative Commons 0
#+OPTIONS: toc:nil
#+KEYWORDS: orther, orther.dev, orther, brandon orther, scala, elixir, erlang, haskell
...
* Forked from @peel's repo 
See https://nur.codearsonist.com

* Status
[[https://travis-ci.org/orther/nur-packages][https://travis-ci.org/orther/nur-packages.svg]]
[[https://orther.cachix.org][https://img.shields.io/badge/cachix-orther-blue.svg]]
#+NAME: expressions
